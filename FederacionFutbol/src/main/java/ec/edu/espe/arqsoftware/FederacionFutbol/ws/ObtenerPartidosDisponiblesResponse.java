 ...
 *       &lt;sequence&gt;
 *         &lt;element name="PartidosRS" type="{http://espe.edu.ec/arqsoftware/FederacionFutbol/ws}PartidosRS" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class ObtenerPartidosDisponiblesResponse {
    ...
    protected List<PartidosRS> partidosRS;
     ...
     * 
     */
    public List<PartidosRS> getPartidosRS() {
        if (partidosRS == null) {
            partidosRS = new ArrayList<PartidosRS>();
        }
